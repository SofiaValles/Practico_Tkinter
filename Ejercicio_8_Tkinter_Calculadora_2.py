...
entry.place(x=80, y=10, width=130, height=20)

entry2 = Entry(ventana, bg="white", validate="key", validatecommand=(validate_cmd, '%S'))
entry2.place(x=80, y=60, width=130, height=20)

entry_res = Entry(ventana, bg="#C1C9D9", state='readonly')
entry_res.place(x=80, y=110, width=130, height=20)
...
button_calcular.place(x=115, y=160)
...
label_op.place(x=270, y=10, width=150, height=20)
